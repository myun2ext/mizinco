...
class AttributesControllerTest < ActionController::TestCase
  ...
  test "should create attribute" do
    assert_difference('Attribute.count') do
      post :create, attribute: { attribute_name: @attribute.attribute_name, name: @attribute.name, value: @attribute.value }
    end
  ...
  test "should update attribute" do
    patch :update, id: @attribute, attribute: { attribute_name: @attribute.attribute_name, name: @attribute.name, value: @attribute.value }
    assert_redirected_to attribute_path(assigns(:attribute))
  end
